export namespace backend {
	...
	export class OKXWalletImportItem {
	    profileId: string;
	    profileName: string;
	    status: string;
	    error?: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new OKXWalletImportItem(source);
	    }
	...
	export class OKXWalletImportResult {
	    total: number;
	    succeeded: number;
	    failed: number;
	    items: OKXWalletImportItem[];
	
	    static createFrom(source: any = {}) {
	        return new OKXWalletImportResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.items = this.convertValues(source["items"], OKXWalletImportItem);
	    }
