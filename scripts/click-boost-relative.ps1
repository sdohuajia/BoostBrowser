...
[WinClick]::GetWindowRect($p.MainWindowHandle, [ref]$rect) | Out-Null
$x = $rect.Left + $RelX
$y = $rect.Top + $RelY
...
[WinClick]::mouse_event([WinClick]::MOUSEEVENTF_LEFTDOWN, 0,0,0,[UIntPtr]::Zero)
Start-Sleep -Milliseconds 80
[WinClick]::mouse_event([WinClick]::MOUSEEVENTF_LEFTUP, 0,0,0,[UIntPtr]::Zero)
